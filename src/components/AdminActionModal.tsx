...
export function AdminActionModal({
  ...
  const triggerClasses = triggerClassName
    ? clsx(
        "inline-flex items-center justify-center gap-2 rounded-xl font-black transition active:translate-y-0",
        triggerClassName,
      )
  ...
  const modal = (
    <div className="fixed inset-0 z-[9999] flex items-end justify-center bg-[#021126]/45 p-3 backdrop-blur-sm sm:items-center sm:p-6">
      <button
        type="button"
        aria-label="Fechar"
